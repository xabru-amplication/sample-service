...
export class TaskResolverBase {
  ...
  async createTask(@graphql.Args() args: CreateTaskArgs): Promise<Task> {
    return await this.service.create({
      ...
      data: {
        ...
        assignerTo: args.data.assignerTo
          ? {
              connect: args.data.assignerTo,
            }
          : undefined,
  ...
  async assignerTo(@graphql.Parent() parent: Task): Promise<User | null> {
    const result = await this.service.getAssignerTo(parent.id);
